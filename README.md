...
This table lists the configuration variables required to operate Axonius Cybersecurity Asset Management. These variables are specified when configuring a Axonius asset in Splunk SOAR.
